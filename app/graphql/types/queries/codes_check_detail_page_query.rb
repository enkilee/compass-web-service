  ...
  module Queries
    class CodesCheckDetailPageQuery < BaseQuery
      ...
      def resolve(label: nil, level: 'repo', branch: 'master',page: 1, per: 9, begin_date: nil, end_date: nil, filter_opts: [], sort_opts: [])
        ...
        pull2_indexer, repo_urls = select_idx_repos_by_label_and_level(label, level, Gitee2PullEnrich, Github2PullEnrich, Gitcode2PullEnrich)
        pull_indexer, repo_urls = select_idx_repos_by_label_and_level(label, level, GiteePullEnrich, GithubPullEnrich, GitcodePullEnrich)
        git_indexer, repo_urls = select_idx_repos_by_label_and_level(label, level, GiteeGitEnrich, GithubGitEnrich, GitcodeGitEnrich)

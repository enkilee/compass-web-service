  ...
  module Queries
    class CommitsDetailPageQuery < BaseQuery
      ...
      def resolve(label: nil, level: 'repo', branch: 'master', page: 1, per: 9, begin_date: nil, end_date: nil,
        ...
        indexer, repo_urls =
                 select_idx_repos_by_label_and_level(label, level, GiteeGitEnrich, GithubGitEnrich, GitcodeGitEnrich)

        pull_indexer, repo_urls =
                  select_idx_repos_by_label_and_level(label, level, GiteePullEnrich, GithubPullEnrich, GitcodePullEnrich)

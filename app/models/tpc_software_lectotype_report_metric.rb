...
class TpcSoftwareLectotypeReportMetric < ApplicationRecord
  ...
  def self.get_compliance_dco(project_url,oh_commit_sha)
    indexer, repo_urls =  select_idx_repos_by_label_and_level(project_url, "repo", GiteeGitEnrich, GithubGitEnrich, GitcodeGitEnrich)
  ...
  def self.get_security_history_vulnerability(project_url)
    indexer, repo_urls =
      select_idx_repos_by_label_and_level(project_url, "repo", GiteeRepoEnrich, GithubRepoEnrich, GitcodeRepoEnrich)
